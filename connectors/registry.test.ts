...
import { connectorRegistry, getConnectorForAgent, registerConnector } from '@/connectors/registry';
import type { AgentConnector, ConnectorProtocol, AgentConfigWithConnector } from '@/connectors/types';
