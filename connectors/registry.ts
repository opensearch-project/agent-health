...
/**
 * Instantiate and register a connector contribution map.
 *
 * Keeping construction at this boundary gives every well-known connector an
 * isolated implementation while preserving the existing object-based
 * `config.connectors` extension point.
 */
